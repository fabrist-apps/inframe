...
void main() {
  test('native and common generation share the typed Responses mapper', () async {
    ...
    server.listen((request) async {
      ...
      expect(request.headers.value('openai-organization'), 'org-1');
    ...
    expect(native.value.status, OpenAIResponseStatus.completed);
  ...
  test('text stream requires terminal semantics and matches ordinary output', () async {
    ...
    expect(native.last, isA<OpenAIResponseCompletedEvent>());
