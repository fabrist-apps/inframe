...
abstract interface class ChroniclerMetrics {
  ...
  ChroniclerHistogram histogram(String name, {required List<num> boundaries, String unit = '1'});
}
...
abstract interface class ChroniclerCounter {
  ...
  void add(num value, {Map<String, Object?> attributes = const {}});
}
...
abstract interface class ChroniclerGauge {
  ...
  void set(num value, {Map<String, Object?> attributes = const {}});
}
...
abstract interface class ChroniclerHistogram {
  ...
  void record(num value, {Map<String, Object?> attributes = const {}});
}
